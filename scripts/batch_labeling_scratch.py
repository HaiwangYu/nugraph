...
# IMPORTANT: Use XRootD-visible PNFS namespace (not the mounted /pnfs/sbnd/...)
PNFS_RECO_BASE = "/pnfs/fnal.gov/usr/sbnd/scratch/users/abhat/dl-light_samples/img-clus"
PNFS_TRUTH_APA0_BASE = "/pnfs/fnal.gov/usr/sbnd/scratch/users/abhat/dl-light_samples/celltree0"
PNFS_TRUTH_APA1_BASE = "/pnfs/fnal.gov/usr/sbnd/scratch/users/abhat/dl-light_samples/celltree1"

# Local script repository (where labeling_with_truth_fixed.py lives)
SCRIPT_DIR = "/home/abhat/Clustering/dlclus_haiwang/script"

# Where to create job output locally (node scratch preferred!)
# NOTE: This MUST be local POSIX FS; do NOT set this to /pnfs/...
LOCAL_OUTPUT_BASE = Path("/scratch/7DayLifetime/abhat/wirecell/clustering/labeled_samples")

# Final stage-out destination (PNFS scratch)
# This is the directory where each job folder (e.g. 67941055_11/) will appear.
PNFS_OUTPUT_BASE = "/pnfs/fnal.gov/usr/sbnd/scratch/users/abhat/dl-light_samples/labeled_samples"
...
# Job list file (optional). If missing/empty, range mode used.
JOBLIST_FILE = ""  # e.g. "/home/abhat/Clustering/dlclus_haiwang/script/joblist.txt"

# Range mode batch IDs / range (RECO batch id + truth batch ids)
RECO_BATCHID = 67941055
CT0_BATCHID  = 25835656
CT1_BATCHID  = 67936426
...
def xrdfs_mkdir_p(pnfs_dir: str) -> bool:
    ...
    pnfs_dir is like: /pnfs/fnal.gov/usr/sbnd/scratch/users/abhat/...
    """
